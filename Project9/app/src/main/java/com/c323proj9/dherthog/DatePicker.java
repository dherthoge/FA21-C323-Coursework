...
/**
 * DatePicker class to get a date from the user. This class uses the Singleton pattern to allow the
 * same DatePicker to work across multiple Activities. (No need to implement the Singleton pattern
 * in this case, I reused this class from my Project 6)
 */
